 ...
 * for recording and transmitting measurement data can be configured via the server.
 * 
...
RecordData()
{
  ...
  /* The for loop gets the measurement values of all two M3 channels and prints them to the console.
     Each measurement is written to the "aRecData" array with calculated byteoffset. An index variable
